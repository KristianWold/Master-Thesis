...
\[ \begin{array}{c}
    \Qcircuit @C=1em @R=1em {
    \lstick{\ket{0}}& \multigate{3}{{U_{\phi(\boldsymbol{x})}}} & \qw    & \multigate{3}{S_{\boldsymbol{\theta}}} & \qw    & \multigate{3}{{U_{\phi(\boldsymbol{-x})}}} & \qw    &  \\
    ...
    \lstick{\ket{0}}& \ghost{{U_{\phi(\boldsymbol{x})}}}        & \qw    & \ghost{S_{\boldsymbol{\theta}}}        & \qw    &\ghost{{U_{\phi(\boldsymbol{-x})}}}        & \qw    &  \\
                    & \underset{Encoding}{\underbrace{}}        &        &\underset{Splitter}{\underbrace{}}    &        &\underset{Reverse Encoding}{\underbrace{}}        &             
    }
    \end{array}\]
\caption{}
\label{fig:QNN}
