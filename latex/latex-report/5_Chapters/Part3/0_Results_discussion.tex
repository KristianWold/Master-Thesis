...
In \autoref{sec:Expressivity}, we assess the expressivity of QCNs and compare them to DNNs using trajectory length as presented in \autoref{sec:TrajectoryLength}. This will be done for both trained and untrained models.
